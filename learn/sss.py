...
for path in os.listdir("data"):
    image_name=str(path).split('.')[0].split('_')[0]
...
#image = face_recognition.load_image_file("face/data/yassir_lambrass_2.png")
#face_encoding = face_recognition.face_encodings(image)[0]
...
known_face_names = [
    os.path.basename("face/data/yassir_lambrass_2.png"),
]
"""
while True:
